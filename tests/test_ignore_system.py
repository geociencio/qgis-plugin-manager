...
from src.qgis_manager.ignore import PathFilter, load_ignore_patterns
...
class TestIgnoreSystem(unittest.TestCase):
    ...
    def test_gitignore_patterns(self):
        ...
        matcher = PathFilter(self.test_root, spec)
        ...
        # Should ignore directory (must exist for is_dir() to work in PathFilter)
